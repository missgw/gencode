 ...
 * @author liangc
 */
public class SaasContractCodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 项目名称
        String projectName = "saas-contract";
        // 定义url路径前缀
        String rootUrlMappering = "contract";
        // 模板名称
        String moduleName = "";
        // 设置程序代码输出根目录
//        String outputRootDir = "/Users/liangchao/IdeaProjects/qjd/qjd-saas/";
...
//        String dbPassword = "qjd123";
//        String dbUrl = "jdbc:mysql://10.1.1.42:3306/saas_user1";

        String dbDriverName = "com.mysql.cj.jdbc.Driver";
        String dbUserName = "root";
        String dbPassword = "123456";
        String dbUrl = "jdbc:mysql://localhost:3306/saas_user1";

        // 表前缀
        String tablePrefix = "sa";

        String[] tables = new String[]{"sa_contract_evidence", "sa_contract_authenticate",
                "sa_contract_file", "sa_contract_process", "sa_contract_signature"};

//        String[] tables = new String[]{}; // 全部生成，慎用！！！！！
        String likeTable = "sa_";

        // 系统版本(用到注释中)
        String version = "1.0";
        // 根包名
        String basePackage = "com.qjdchina.saas." + rootUrlMappering;
        // 开发人员
        String author = "renjianglin";
        ...
        // 模板文件路径
        String templateDir = "qjd-saas-boss";
        ...
        // 自定义继承的Entity类全称，带包名
        strategy.setSuperEntityClass("com.qjdchina.saas.common.web.BossBaseModel");
        // 自定义基础的Entity类，公共字段
