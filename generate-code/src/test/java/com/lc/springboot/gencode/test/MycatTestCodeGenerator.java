package com.lc.springboot.gencode.test; // package com.chinamobile.zj.idc.management.config;
 ...
 * @author liangc
 */
public class MycatTestCodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String version = "1.0";
        // 项目名称
        String projectName = "mycat-study-01";
        // 定义url路径前缀
        String rootUrlMappering = "mycat";
        // 模板名称
        String moduleName = "";
        // 顶层包名
        String baseParentPkg = "com.liangc.study";
        // 根包名
        String basePackage = baseParentPkg + "." + rootUrlMappering;
        // 开发人员
        String author = "liangchao";

        //是否生成feign client代码
        boolean enableFeignClient = false;
        // 设置程序代码输出根目录
//        String outputRootDir = "/Users/liangchao/tmp2/";
        String outputRootDir = "/Users/liangchao/IdeaProjects/xingshu/stardigi/study-self/";
        // 设置代码输出目录
...
//        String dbDriverName = "com.mysql.jdbc.Driver";
        ...
        String dbUrl = "jdbc:mysql://localhost:3306/mycat_db1";
