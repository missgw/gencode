 ...
 * @author liangc
 */
public class QjdCreditReportCode_TEMP_Generator extends AbstractSaasBaseGenCode {

    public static void main(String[] args) {

        AbstractSaasBaseGenCode genCode = new QjdCreditReportCode_TEMP_Generator();

        // 指定数据库
        genCode.dbUrl = "jdbc:mysql://localhost:3306/credit_report";
        ...
        // 根实体类
        genCode.superEntityClassName = "com.qjdchina.creditreport.common.model.CreditReportBaseModel";
        // 根mapper类
        genCode.superMapperClass = "com.qjdchina.creditreport.mapper.base.ExtBaseMapper";
        // 是否启动枚举类生成（通过表字段的注释生成，前提注释要书写规范）
        genCode.enableEnum = true;
        // 公共字段
        genCode.commonFieldsArray = new String[]
                {"id", "creator", "modifier", "create_time", "update_time", "delete_flag", "version"};
        ...
        genCode.dtoOutputRootDir = "/Users/liangchao/tmp/qjd-credit-report/credit-report-service-api/";


        genCode.tablePrefix = "cr";
        genCode.likeTable = "cr_";
...
//                "cr_person_credit_report_base","cr_house","cr_vehicle","cr_land","cr_person_id_card"};
        ...
        genCode.tables = new String[]{"cr_vehicle"};
//        // 梁超
...
//                "cr_vehicle", "cr_land", "cr_corp_finance_base", "cr_corp_finance_debt", "cr_corp_finance_item",
//                "cr_corp_finance_profit", "cr_corp_finance_invoiced_sales", "cr_bank_water_base", "cr_bank_water_detail_base",
//                "cr_bank_water_detail_item", "cr_bank_water_simple", "cr_file", "cr_diligence_report", "cr_diligence_report_company_base"};
