 ...
 * @author liangc
 */
public class QjdCreditReportCodeGenerator extends AbstractSaasBaseGenCode {

    public static void main(String[] args) {

        AbstractSaasBaseGenCode genCode = new QjdCreditReportCodeGenerator();

        // 指定数据库
//        genCode.dbUrl = "jdbc:mysql://localhost:3306/bigfrog";
...
//                "cr_person_credit_report_base", "cr_house", "cr_vehicle", "cr_land", "cr_person_id_card"};
        ...
        genCode.tables = new String[]{"cr_person_credit_report_base"};
//        // 梁超
