...
public class ${table.controllerName} {
    ...
    */
    ...
    @Authorize({})
    public RestBody<${entity}> get(@PathVariable Long id) {
        ${entity} info = ${table.serviceImplName?uncap_first}.getById(id);
        return RestBody.success(info);
    }
    ...
    */
    ...
    @Authorize({})
    public RestBody delete(@PathVariable Long id) {
