...
public interface ${table.feignClientName} {
    ...
    */
    ...
    RestBody<${table.dtoUpdateName}> create(
    ...
    */
    ...
    RestBody<${table.dtoDetailName}> list(
        @RequestHeader(AuthConstant.AUTHORIZATION_HEADER) String authz,
    ...
    */
    ...
    RestBody<${table.dtoDetailName}> get(
    ...
    */
    @DeleteMapping(path = "/delete/{id}")
        RestBody delete(@RequestHeader(AuthConstant.AUTHORIZATION_HEADER) String authz,@PathVariable Long id);
}
