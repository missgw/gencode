...
import com.qjdchina.saas.common.web.BaseModel;
...
public class ${table.serviceImplName} extends ${superServiceImplClass}<${table.mapperName}, ${entity}> implements ${table.serviceName} {
     ...
     public ${table.serviceImplName}(ModelMapper modelMapper) {
     ...
     public MyPageInfo<${table.dtoDetailResponseName}> list(${table.dtoQueryName} ${table.dtoQueryName?uncap_first}, Pageable pageable) {
        ...
        mapper.orderByDesc(BaseModel.COL_CREATED_TIME);

        List<${entity}> ${entity?uncap_first}s = ${table.mapperName?uncap_first}.selectList(mapper);
        List<${table.dtoDetailResponseName}> detailList =
        ${entity?uncap_first}s.stream().map(a -> convertToDetail(a)).collect(Collectors.toList());

        return new MyPageInfo<>(detailList);
     }
    ...
    private QueryWrapper<${entity}> queryWrapper(${table.dtoQueryName} ${table.dtoQueryName?uncap_first}) {
        ...
        mapper.ge(${table.dtoQueryName?uncap_first}.getQueryStartDate() != null ,BaseModel.COL_CREATED_TIME,${table.dtoQueryName?uncap_first}.getQueryStartDate());
        mapper.le(${table.dtoQueryName?uncap_first}.getQueryEndDate()!= null ,BaseModel.COL_CREATED_TIME,${table.dtoQueryName?uncap_first}.getQueryEndDate());
        return mapper;
    }
