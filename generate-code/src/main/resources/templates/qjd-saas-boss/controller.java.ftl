...
import com.qjdchina.saas.common.holder.RequestUserHolder;
...
public class ${table.controllerName} {
    ...
    */
    ...
    public RestBody<${table.dtoDetailResponseName}> get(@PathVariable Long id) {
        ...
        ${table.dtoDetailRequestName?uncap_first}.setOrgId(RequestUserHolder.getOrgId());
    ...
    */
    ...
    public RestBody<Void> delete(@PathVariable Long id) {
        ...
        ${table.dtoDeleteRequestName?uncap_first}.setOrgId(RequestUserHolder.getOrgId());
