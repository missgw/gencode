...
<#list table.fields as field>
    <#if field.columnType == "BIG_DECIMAL" || field.columnType == "INT" || field.columnType == "LONG">
...
public class ${table.dtoAddName} extends BossBaseRequest implements Serializable {
