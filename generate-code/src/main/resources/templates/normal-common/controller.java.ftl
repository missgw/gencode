...
import ${package.BaseParentPkg}.common.web.RestBody;
...
public class ${table.controllerName} {
    ...
    */
    ...
    public RestBody<MyPageInfo<${entity}>> list(
        ${entity}QueryRequest ${table.dtoQueryName?uncap_first}, @PathVariable int page, @PathVariable int size) {
        Pageable pageable = PageRequest.of(page, size);
        MyPageInfo<${entity}> list = ${table.serviceName?uncap_first}.list(${table.dtoQueryName?uncap_first}, pageable);
