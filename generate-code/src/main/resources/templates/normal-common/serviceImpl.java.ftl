...
import ${package.BaseParentPkg}.common.web.MyPageInfo;
import ${package.BaseParentPkg}.common.exception.error.BusinessErrorCode;
import ${package.BaseParentPkg}.common.exception.BusinessException;
...
public class ${table.serviceImplName} extends ${superServiceImplClass}<${table.mapperName}, ${entity}> implements ${table.serviceName} {
     ...
     public MyPageInfo<${entity}> list(${table.dtoQueryName} ${table.dtoQueryName?uncap_first}, Pageable pageable) {
        ...
        mapper.orderByDesc(${entity}.COL_ID);
