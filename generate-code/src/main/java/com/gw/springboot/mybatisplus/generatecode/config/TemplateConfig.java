...
public class TemplateConfig {
    ...
    private String dtoDetailRequest = ConstVal.TEMPLATE_DTO_DETAIL_REQUEST;

    private String dtoDetailResponse = ConstVal.TEMPLATE_DTO_DETAIL_RESPONSE;

    private String dtoDeleteRequest = ConstVal.TEMPLATE_DTO_DELETE_REQUEST;
            ...
            for (TemplateType templateType : templateTypes) {
                switch (templateType) {
                    ...
                    case DTO_UPDATE:
                        setDtoUpdate(null);
                        break;
                    case DTO_DETAIL_REQUEST:
                        setDtoDetailRequest(null);
                        break;
                    case DTO_DETAIL_RESPONSE:
                        setDtoDetailResponse(null);
                        break;
                    case DTO_DELETE_REQUEST:
                        setDtoDeleteRequest(null);
                        break;
                    case FEIGN_CLIENT:
                        setFeignClient(null);
                        break;
